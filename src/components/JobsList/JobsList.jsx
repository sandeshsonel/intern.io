...
const JobsList = (props) => {
  ...
  const toggleJobsDetailsDrawer = (anchor, open, userId, companyJobsDetails) => (event) => {
    if (event.type === "keydown" && (event.key === "Tab" || event.key === "Shift")) {
      return;
    }
    setSelectJob({ userId, companyJobsDetails });

    setJobsDetailsDrawer({ right: open });
  };
  ...
  return (
    <div className="mt-5 space-y-4">
      {jobs.map(({ userId, companyJobsDetails }) => (
        <div className="xl:flex xl:items-center xl:justify-between py-4 border-gray-300 bg-white px-4 border hover:border-gray-500 hover:shadow-md">
          ...
          <div className="flex items-center space-x-4">
            <button onClick={() => handleClickSavedJob(userId, companyJobsDetails._id)} className="outline-none focus:outline-none">
            ...
            <button
              onClick={
                toggleJobsDetailsDrawer("left", true, userId, companyJobsDetails)
                // setSelectJob({ userId, companyJobsDetails });
              }
      ...
      <Drawer anchor="right" open={jobsDetailsDrawer["right"]} onClose={toggleJobsDetailsDrawer("right", false)}>
