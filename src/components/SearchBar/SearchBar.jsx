...
const SearchBar = (props) => {
  ...
  const handleSearch = () => {
    ...
    if (searchInput.length || category !== "")
      getAllJobsStart({ searchInput, category });
    setCategory("");
    setSearchInput("");
  };
  ...
  return (
    <div className="md:flex lg:flex xl:flex w-full xl:space-x-4 lg:space-x-3 md:space-x-2 lg:space-y-0 md:space-y-0 space-y-2 md:mt-8 mt-6">
      <div className="w-full relative">
        <div
          className={`flex items-center bg-white px-3 xl:px-4 w-full ${
            inputFocused
              ? "border-2 xl:border-4 border-blue-600 focus:ring-2"
              : "border-2 xl:border-4 border-gray-300"
          }`}
        >
          <div>
            <svg
          ...
          {searchInput && (
            <button
              ...
              className="outline-none focus:outline-none px-1 py-1 bg-gray-200 rounded-full"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-4"
      ...
      <div className="relative bg-white border-2 xl:border-4 border-gray-300">
        <select
          className="w-full md:w-60 lg:w-64 xl:w-64 py-2 bg-white md:py-3 lg:py-4 xl:py-4 px-3 xl:px-4 cursor-pointer pr-8 appearance-none placeholder-gray-400 lg:text-lg outline-none focus:outline-none focus:ring-2 xl:focus:ring-4 focus:ring-blue-600"
          name=""
          id=""
