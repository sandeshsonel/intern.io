...
const Header = (props) => {
  ...
  return (
    <div
      ...
      className="py-2 xl:py-4 border-b-2 border-gray-200 sticky z-50 top-0 w-full"
    >
      <div className="max-w-6xl m-auto lg:px-0">
        <div className="flex items-center justify-between">
          <div className="relative ml-4 xl:ml-0 flex items-center">
            <Link to="/">
              <a
                className="text-2xl lg:text-2xl xl:text-4xl font-semiBold"
                href=""
              >
                intern.io
              </a>
          ...
          <div className="flex items-center space-x-2">
            {isLogin ? (
                ...
                <div className="relative">
                  <button className="outline-none focus:outline-none px-2 py-2 hover:bg-gray-100 rounded-full">
                    <svg
                      ...
                      className="w-5 xl:w-6 text-black fill-current"
                      viewBox="0 0 512 512"
                    >
              ...
              <div className="space-x-3 mr-3 xl:space-x-4">
                <Link to="/signup">
                  <button className="font-medium outline-none text-sm xl:text-base focus:outline-none">
                    Register
                  </button>
                </Link>

                <Link to="/login">
                  <button className="font-medium text-sm xl:text-base px-4 py-3 bg-black text-white outline-none focus:outline-none">
                    Log in
                  </button>
                </Link>
              </div>
